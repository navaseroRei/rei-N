...
const ProjectCard = ({
  ...
  return (
    <motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)}>
      <div className='relative w-full bg-gradient-to-b  flex  from-sky-900/25 to-emerald-600/85 rounded-xl h-[230px]'>
        <img
          src={image}
          alt='project_image'
          className='w-full h-full object-contain mt-2 rounded-2xl'
        />
