    ...
    >
      <div className=' flex  w-full flex-row justify-between text-white'>
        ...
        >
          ...
          <h1 className='uppercase font-lexend font-black text-xl bg-gradient-to-r from-sky-500 to-emerald-400 bg-clip-text text-transparent'>
            RN
          </h1>
        </Link>
            ...
            <li
              ...
              className={`${
                active === nav.title
                  ...
                  : 'text-white'
              }    font-lexend cursor-pointer hover:scale-110`}
